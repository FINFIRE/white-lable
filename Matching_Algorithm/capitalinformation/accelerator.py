...
def accelerator(request):
    ...
    <p><b><u>Definition of Capital Market: Accelerator</u></b><br></p>
...
<br>
    <br>To raise capital through a public accelerator, startups must complete a formal application process demonstrating innovation, scalability, and alignment with the program’s public mission. Most programs require evidence of early traction, a working MVP, and a committed founding team. Selected startups participate in structured programming, including mentorship, workshops, pilot projects, and progress reviews. Funding is typically provided in the form of grants or seed capital, accompanied by strict reporting and compliance requirements. Programs often conclude with demo days or evaluations that connect startups with investors, government agencies, and strategic partners. A strong application highlighting impact, market potential, and execution capability is critical for selection success. (PitchBob.io, n.d.)
    </p>
...
<br>
    <br>The CEO Strategy. (2024). Are startup accelerators worth it? Pros & cons. <a href="https://slidebean.medium.com/are-startup-accelerators-worth-it-f6e475f4fe0a?source=follow_footer---------3----------------------------">https://slidebean.medium.com/are-startup-accelerators</a>
<br>
    <br>PitchBob.io. (n.d.). How to get accepted into ERA Accelerator. <a href="https://pitchbob.io/library/accelerators/how-to-get-accepted-into-era-accelerator-an-insider-s-guide-for-startup-founders-pitchbob-io">https://pitchbob.io/library/accelerators/how-to-get-accepted-into-era-accelerator-an-insider-s-guide-for-startup-founders-pitchbob-io</a>
    </p>
...
def acceleratorfaq(request):
    introduction = mark_safe("""                      
    <p><b><u>FAQs</u></b></p>
                             
    <p><b><u>1. What is a public accelerator?</u></b><br>
    •Answer: A public accelerator is a startup acceleration program supported or funded by government bodies, public institutions, or non-profit organizations. Its primary objective is to promote innovation, economic development, and job creation by helping early-stage startups grow through structured mentorship, technical assistance, and access to public and private networks.</p>
                             
    <p><b><u>2. How does a public accelerator differ from private accelerators or VC programs?</u></b><br>
    • Answer: Unlike private accelerators or venture capital firms, public accelerators are not primarily driven by profit maximization. They focus on capacity building, commercialization, and ecosystem development. Funding, if provided, is often non-dilutive or minimally dilutive, and programs place greater emphasis on long-term sustainability rather than rapid exits.</p>
                             
    <p><b><u>3. What stage of companies are best suited for a public accelerator?</u></b><br>
    • Answer: Public accelerators typically support pre-revenue to early-revenue startups that have a defined problem, a prototype or minimum viable product (MVP), and early market validation. They are especially suitable for startups preparing for commercialization or future private investment.</p>                             
                             
    <p><b><u>4. Do public accelerators provide funding?</u></b><br>
    <br>• Answer: Yes, some public accelerators provide funding, but it is usually modest and structured as grants, stipends, milestone-based support, or small equity investments. Many programs prioritize non-financial support and investment readiness over direct capital deployment.
    </p>
                             
    <p><b><u>5. How much funding can startups expect from a public accelerator?</u></b><br>
    • Answer: Funding amounts vary widely by country and program. Typical support ranges from small grants or stipends to seed-level funding. Compared to private accelerators, the financial component is often secondary to mentorship, infrastructure, and policy support.</p>
                             
    <p><b><u>6. How quickly can startups access support after selection?</u></b><br>
    • Answer: Once selected, startups usually gain immediate or near-immediate access to program resources such as mentorship, workspace, and training. Any financial support is commonly released early in the program or upon achieving defined milestones.</p>
                             
    <p><b><u>7. Do public accelerators require equity?</u></b><br>
    • Answer: Many public accelerators do not require equity. When equity is taken, it is generally lower than private accelerators and structured to align with public-interest goals rather than financial returns. Grant-based models are common.</p>
                             
    <p><b><u>8. Can startups raise capital while participating in a public accelerator?</u></b><br>
    • Answer: Yes. Public accelerators actively encourage startups to pursue additional funding during or after the program. Demo days, investor introductions, and connections to public financing schemes are common features, with minimal restrictions on external fundraising.</p>
                             
    <p><b><u>9. What types of support do public accelerators provide?</u></b><br>
    • Answer: Public accelerators offer structured mentorship, business development support, regulatory guidance, access to public research institutions, pilot programs, subsidized office space, and connections to investors, corporates, and government agencies.</p>
                             
    <p><b><u>10. What happens at the end of a public accelerator program?</u></b><br>
    • Answer: At program completion, startups often present at demo days or evaluation panels. Follow-on support may include continued mentorship, referrals to private accelerators, access to public grants, or assistance with seed or Series-A readiness.</p>
    
    <p><b><u>11. What are the main benefits of joining a public accelerator?</u></b><br>
    • Answer: Key benefits include low or no equity dilution, access to public infrastructure and policy networks, credibility enhancement, long-term support orientation, and strong ecosystem integration. Public accelerators are particularly valuable for first-time founders.</p>
    
    <p><b><u>12. Are there risks associated with public accelerators?</u></b><br>
    • Answer: Risks include slower decision-making processes, limited funding size, and less aggressive growth pressure compared to private accelerators. Some programs may prioritize policy alignment over market speed.</p>
    
    <p><b><u>13. How does a public accelerator compare to angel investors?</u></b><br>
    ...
    <p><b><u>14. What types of startups are commonly accepted into public accelerators?</u></b><br>
    • Answer: Public accelerators frequently support technology-driven, impact-oriented, and innovation-based startups in sectors such as fintech, healthtech, cleantech, agritech, education, and social enterprise.</p>

    <p><b><u>15. How can startups improve their chances of acceptance?</u></b><br>
    • Answer: Startups should demonstrate a clear problem-solution fit, social or economic impact potential, early validation, and alignment with the accelerator’s public mission. Strong teams and scalable models significantly improve acceptance prospects.</p>
    """)
...
def acceleratortwelve(request):
    ...
    up_front_cost_options ={
        'Minimum $0 - Maximum $499' : 'this is not enough to cover necessary updates to cap table models, IP assignments, and founder agreements.',
        'Minimum $500 - Maximum $999' :  'this is not enough to cover necessary updates to cap table models, IP assignments, and founder agreements.',
        'Minimum $1000 - Maximum $2499' :  'this usually is not enough to cover necessary updates to cap table models, IP assignments, and founder agreements.',
        'Minimum $2500 - Maximum $4999' :  'this usually is enough to cover necessary updates to cap table models, IP assignments, and founder agreements.',
        'Minimum $5000 - Maximum $9999' :  'this usually is enough to cover necessary updates to cap table models, IP assignments, and founder agreements.',
        'Minimum $10000 - Maximum $24999' : 'this should cover necessary updates to cap table models, IP assignments, and founder agreements.',
        'Minimum $25000 - Maximum $49999' : 'this should cover necessary updates to cap table models, IP assignments, and founder agreements.',
        'More than $50000+' : 'tthis should cover necessary updates to cap table models, IP assignments, and founder agreements.',             
    }
    costanalysis = up_front_cost_options[upfrontcost]

    #Up front Cost options
    up_front_time_options ={
        '1 Day to 1 Week' : 'does not allign with upfront time to raise capital through accelerator program.',
        '1 Week to 2 Week' : 'does not allign with upfront time to raise capital through accelerator program.',
        '2 Weeks to 4 Weeks' : 'does not allign with upfront time to raise capital through accelerator program.',
        '1 Month to 2 Months' : 'alligns with upfront time to raise capital through accelerator program.',
        '2 Months to 3 Months' : 'alligns with upfront time to raise capital through accelerator program.',
        '3 Months to 6 Months' : 'alligns with upfront time to raise capital through accelerator program.',
        '6 Months to 12 Months' : 'alligns with upfront time to raise capital through accelerator program.',
        'More than 1 year' : 'alligns with upfront time to raise capital through accelerator program.',             
    }
    timeanalysis = up_front_time_options[upfronttime]

    introduction = """
   <b><u>FINFIRE CAPITAL MATCH REPORT FOR:</u></b><br>
    Public Accelerator 
...
<br>Use of funds for personal expenses, unrelated investments, or debt repayment is typically prohibited and monitored.
    </p>
